...
{
	if(GPIO_void_Set_Direction(Copy_u8Reg , Copy_u8Pin , OUTPUT  ) == GPIO_OK)
	{
		return LED_OK;
	}
	else
...
{
	if(GPIO_void_Set_Value(Copy_u8Reg ,Copy_u8Pin , HIGH ) == GPIO_OK)
	{
		return LED_OK;
	}
	else
...
{
	if(GPIO_void_Set_Value(Copy_u8Reg ,Copy_u8Pin , LOW ) == GPIO_OK)
	{
		return LED_OK;
	}
	else
